# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2017-03-21 20:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('team', models.CharField(default='team_name', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forfeit_date', models.DateField(default=datetime.date(2017, 3, 26), verbose_name='Forfeit Date')),
                ('void_date', models.DateField(default=datetime.date(2017, 4, 4), verbose_name='Void Date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server', models.IntegerField(choices=[(1, 'Radius'), (2, 'Pi'), (3, 'Origin'), (4, 'Sphere'), (5, 'Centra'), (6, 'Orbit'), (7, 'Chord'), (8, 'Diameter')], verbose_name='Server')),
                ('position', models.IntegerField(choices=[(1, 'O'), (2, 'D'), (3, 'O/D'), (4, 'D/O')], verbose_name='Position')),
                ('mic', models.BooleanField(default=True, verbose_name='Mic?')),
                ('tagpro_profile', models.URLField(verbose_name='TagPro Profile')),
                ('reddit_info', models.URLField(blank=True, null=True, verbose_name='Reddit Info')),
                ('tagpro_stats', models.URLField(blank=True, null=True, verbose_name='TagPro Stats Profile')),
