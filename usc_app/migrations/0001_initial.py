# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2017-06-16 19:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forfeit_date', models.DateField(default=datetime.date(2017, 6, 21), verbose_name='Forfeit Date')),
                ('void_date', models.DateField(default=datetime.date(2017, 6, 30), verbose_name='Void Date')),
        ...
        migrations.AddField(
            model_name='challenge',
            name='submitted_by',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='submitted_by', to=settings.AUTH_USER_MODEL, verbose_name='Submitted By'),
        ),
        migrations.AddField(
            model_name='challenge',
            name='winner',
