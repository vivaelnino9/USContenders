    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forfeit_date', models.DateField(default=datetime.date(2017, 3, 1), verbose_name='Forfeit Date')),
                ('void_date', models.DateField(default=datetime.date(2017, 3, 10), verbose_name='Void Date')),
